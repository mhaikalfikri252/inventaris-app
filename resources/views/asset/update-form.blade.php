                        ...
                        <form>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="status_asset_id" id="status_asset_id" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('information') is-invalid @enderror"
                                        ...
                                        value="{{ old('information', $asset->information) }}">
                                    @error('information')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ $asset->status_asset_id == 1 ? route('asset.index') : route('writeoff.index') }}"
