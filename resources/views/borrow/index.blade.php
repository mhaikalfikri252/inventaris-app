                            ...
                            <div class="card">
                                @if (auth()->user()->role_id == 2)
                                    <div class="card-header">
                                        <a href="{{ route('borrow.create') }}" class="btn btn-success btn-style">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="dt-responsive table-responsive">
                                        @if (auth()->user()->role_id == 1)
                                            <table id="table-borrow" class="table table-striped table-bordered nowrap">
                                            @else
                                                <table id="table-borrow-user"
