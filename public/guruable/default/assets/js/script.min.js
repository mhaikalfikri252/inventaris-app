...
$(document).ready(function () {
    ...
    $(".main-menu").attr("id", a),
        ...
        $(".card-header-right .minimize-card").on("click", function () {
            var e = $(this),
                a = $(e.parents(".card"));
            $(a).children(".card-block").slideToggle();
            $(this).toggleClass("icofont-plus").fadeIn("slow");
        }),
        $(".card-header-right .full-card").on("click", function () {
            var e = $(this),
                a = $(e.parents(".card"));
            a.toggleClass("full-card"), $(this).toggleClass("icofont-resize");
        }),
    ...
    $(".main-friend-list").slimScroll({
        ...
        $("#search-friends").on("keyup", function () {
            ...
            $(".userlist-box .media-body .chat-header").each(function () {
                ...
                $(this)
                    ...
                    [-1 !== a.indexOf(e) ? "show" : "hide"]();
            });
        }),
        $(".displayChatbox").on("click", function () {
            var e = $(".pcoded").attr("vertical-placement");
            if ("right" == e) var a = { direction: "left" };
            else var a = { direction: "right" };
        ...
        $(".lng-dropdown a").on("click", function () {
            var e = $(this),
                a = e.data("lng");
            i18next.changeLanguage(a, function (e, a) {
                $(".main-menu").localize();
            }),
                e
                    .parent("li")
            ...
            var t = $('.lng-dropdown a[data-lng="' + a + '"]').addClass(
                "active"
            );
            $(".lng-dropdown #dropdown-active-item").html(t.html());
        });
}),
    $(document).ready(function () {
        $(function () {
