                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5>Form Edit Data Inventaris</h5>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text"
                                                    ...
                                                    value="{{ old('inventory_name', $inventory->inventory_name) }}"
                                                    required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text"
                                                    ...
                                                    name="price" value="{{ old('price', $inventory->price) }}" required>
                                                @error('price')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="5" cols="5" class="form-control @error('information') is-invalid @enderror" id="information"
                                                    name="information">{{ old('information', $inventory->information) }}</textarea>
                                                @error('information')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
